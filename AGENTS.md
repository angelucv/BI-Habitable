...
| Fecha | Tema | Git |
|-------|------|-----|
| **27/08/2026** | **Fase II ROJO Django** (190.169.110.9): import PDF enriquecido 36 cruce; ranking nacional `--todas-hojas`; manual ejecutivo; guía dev §10; systemd + `deploy_sprint_operativo.py`. App en `docs/demolicion-ronda2/fase2-rojo/`. | (push BI-Habitable) |
